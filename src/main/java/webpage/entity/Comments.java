...
public class Comments {
    ...
    public static Integer findCommentVotesByUserIdAndCommentId(Long userId, Long commentId){
    ...
    public static List<CommentResponse> createCommentResponseList(List<Comment> comments, Long userId){
        ...
        for (Comment comment : comments) {
            ...
            commentResponseList.add(new CommentResponse(comment, user.get().getNickname(), vote));
        }
