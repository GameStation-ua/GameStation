            ...
            post("/attachImg", (req, res) -> {
                ...
                switch (imgType) {
                    case MAIN:
                        ...
                        return upload(req, res, "960", "540", "src/main/resources/public/game_requests/" + req.headers("id") + "/main.png");
                    case CAROUSEL:
                        ...
                        String returnMessage = upload(req, res, "960", "540", "src/main/resources/public/game_requests/" + req.headers("id") + "/carousel=" + (gameRequest1.get().getImgsInCarousel() + 1) + ".png");
                    ...
                    case GAME_UPDATE:
                        ...
                        return upload(req, res, "960", "540", "src/main/resources/public/game_updates/" + gameUpdate.get().getId() + ".png");
                    case PROFILE:
                        return upload(req, res, "540", "540", "src/main/resources/public/profile_pictures/" + getIdByToken(token) + ".png");
