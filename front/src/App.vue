  ...
  <template v-else>
    ...
    <vs-navbar v-model="activeItem" class="nabarx">
      ...
      <div class="rightx">
        ...
        <vs-input icon="search" style="color: white" placeholder="Search" v-model="$store.state.search" color="success"/>
    ...
    <div id="parentx">
      <vs-sidebar parent="body" default-index="1"  color="success" class="sidebarx" spacer v-model="active">
        ...
        <vs-sidebar-item index="1" icon="question_answer" color="success">
          Dashboard
        </vs-sidebar-item>
